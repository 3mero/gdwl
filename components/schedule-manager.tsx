...
import { Plus, Trash2, Copy, Upload, Download, Edit, Save, X, SlidersHorizontal, ZoomIn, ZoomOut, LayoutGrid, Smartphone, AlertTriangle } from 'lucide-react';
...
export function ScheduleManager({ 
  ...
  const { schedules, deleteSchedule, updateSchedule, duplicateSchedule, importFullData, setSchedules, deleteAllData } = useSchedules();
