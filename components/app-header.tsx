...
import { BackgroundColors, ThemeFile, ColorPreset, ViewSettings } from '@/lib/types';
...
export function AppHeader({ 
  ...
  return (
    ...
    <Dialog open={isColorPickerOpen} onOpenChange={setIsColorPickerOpen}>
        <DialogContent className="max-w-lg h-[90vh] sm:h-auto flex flex-col" dir="rtl">
            <DialogHeader>
            ...
            <DialogFooter className="flex-col sm:flex-row sm:justify-between items-center gap-2 pt-4 border-t shrink-0">
                <Button variant="ghost" onClick={handleColorReset}>
                ...
                <div className="flex flex-wrap justify-center gap-2">
                    ...
                    <AlertDialog open={isSavePromptOpen} onOpenChange={setIsSavePromptOpen}>
                      ...
                      <AlertDialogContent dir="rtl">
                        <AlertDialogHeader>
                          <DialogTitle>حفظ الثيم الحالي</DialogTitle>
                          <DialogDescription>
